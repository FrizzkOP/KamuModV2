...
public class WeedCigarreteCaseItem extends Item {
    public WeedCigarreteCaseItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if(pPlayer.getInventory().add(new ItemStack(ModItems.PORRITO_MARIHUANA.get())) == false){
            pPlayer.drop(new ItemStack(ModItems.PORRITO_MARIHUANA.get()), false);
        }
