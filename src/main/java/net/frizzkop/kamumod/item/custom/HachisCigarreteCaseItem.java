...
public class HachisCigarreteCaseItem extends Item {
    public HachisCigarreteCaseItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if(pPlayer.getInventory().add(new ItemStack(ModItems.PORRITO_HACHIS.get())) == false){
            pPlayer.drop(new ItemStack(ModItems.PORRITO_HACHIS.get()), false);
        }
